/* ==========================================================================
   MASTER ARCANE FLAVOR TEXT & COMBINATORIAL LORE LEXICON
   Contains all elemental themes, hybrid/overdrive reactions, and combinatorial matrices.
   ========================================================================== */
...
// ==========================================================================
// 0. MASTER ELEMENTAL HYBRID & SAME-ELEMENT HARMONIC RESONANCE MATRIX (36 Pairs)
// ==========================================================================

const HYBRID_REACTIONS = {
    // -------------------------------------------------------------
    // A. 8 HOMOGENEOUS SAME-ELEMENT HARMONIC RESONANCE OVERDRIVES
    // -------------------------------------------------------------
    "sfalhoy+sfalhoy": {
        name: "Resonant White-Hot Hellfire",
        compoundName: "Resonant Hellfire",
        stem: "Shalshal",
        desc: "harmonic thermal resonance, blinding white-hot plasma, and self-amplifying thermonuclear fury",
        adj: "Thermonuclear",
        noun: "Hellfire",
        prefix: "Hyper-Thermal",
        coat: "White-Hot Plasma Mantle",
        edge: "Thermonuclear Blade",
        synergyBuff: "Harmonic Thermal Resonance: Dual fire roots create a self-amplifying thermal feedback loop, instantly converting standard fire into searing white-hot plasma.",
        hazardText: "Thermal Overheat Hazard (Hlakbil): Channeling double-frequency fire mana without Adamantine Hardening (Kunta) will cause thermal shock and severe tissue flashover.",
        shapes: {
            yangga: "a blinding needle of hyper-resonant, white-hot plasma that vaporizes matter before impact",
            taddum: "a vibrating plasma scythe of double-frequency combustion that cuts through solid armor like butter",
            gilbo: "a superheated, gravitationally compressed white-hot star orb of pure thermonuclear fury",
            yinla: "a coherent, ultra-dense beam of white-hot laser heat that bores instantaneously through steel",
            praba: "a roaring vertical wall of double-frequency white-hot plasma that vaporizes incoming projectiles",
            ngisngi: "a spinning annular halo of pure solar plasma discharging relentless solar flares",
            apap: "an overwhelming, wide-angled cone of white-hot dragon fire that flash-incinerates the field",
            abbay: "a 360-degree domain of blinding white-hot thermal updrafts and scorched ground",
            default: "a double-resonant, blinding mass of white-hot combustible plasma"
        }
    },
    "hanhum+hanhum": {
        name: "Cataclysmic Maelstrom Deluge",
        compoundName: "Maelstrom Deluge",
        stem: "Hanhan",
        desc: "compounded hydrostatic pressure, laminar cavitation waves, and boundless ocean-trench mass",
        adj: "Cataclysmic Tidal",
        noun: "Maelstrom",
        prefix: "Hyper-Hydraulic",
        coat: "Hadal Pressure Mantle",
        edge: "Cavitation Edge",
        synergyBuff: "Hydrostatic Resonance: Compounded water vectors generate catastrophic cavitation shockwaves, multiplying crushing kinetic yield.",
        hazardText: null,
        shapes: {
            yangga: "a hyper-pressurized, double-density laminar water javelin with crushing kinetic density",
            taddum: "a high-frequency dual-oscillating laminar blade capable of slicing clean through battlements",
            gilbo: "a dense, crushing orb of deep-ocean hydrostatic pressure spinning in a vortex",
            yinla: "an industrial-grade, double-pressurized hydro-cutting beam capable of boring through stone",
            praba: "a towering rectangular deluge of dense, crushing water that absorbs and reflects physical strikes",
            ngisngi: "a dual-spinning annular ring of razor-sharp vortex currents and crushing fluid ribbons",
            apap: "a torrential, expanding cone of extreme-PSI deluge that flattens entire vanguard lines",
            abbay: "a room-wide flood of churning oceanic water that drowns and crushes everything caught within",
            default: "a dense, compounded volume of ultra-pressurized oceanic water"
        }
    },
    "falga+falga": {
        name: "Adamantine Bedrock Monolith",
        compoundName: "Adamantine Bedrock",
        stem: "Falfal",
        desc: "compounded geological density, indestructible diamond bedrock, and catastrophic seismic mass",
        adj: "Adamantine Tectonic",
        noun: "Bedrock Monolith",
        prefix: "Hyper-Geo",
        coat: "Diamond-Bedrock Carapace",
        edge: "Adamantine Tectonic Edge",
        synergyBuff: "Tectonic Mass Compounding: Doubles physical mineral density into diamond-grade bedrock, rendering constructs virtually impervious to physical destruction.",
        hazardText: null,
        shapes: {
            yangga: "an indestructible diamond-tipped bedrock monolith lance with overwhelming mineral mass",
            taddum: "a massive, double-density slab of tectonic basalt and razor-honed obsidian",
            gilbo: "a gravitationally dense, solid boulder of compressed adamantine bedrock",
            yinla: "a continuous high-velocity spear-line of pulverized diamond grit and tectonic bedrock",
            praba: "an impenetrable monolithic bastion of double-reinforced bedrock that deflects siege fire",
            ngisngi: "an orbiting belt of heavy, rapidly spinning adamantine stone monoliths",
            apap: "a violent, flaring cone of seismic rock eruptions and diamond-hard mineral flak",
            abbay: "a field-wide fortress of upheaved tectonic spires and reinforced bedrock plates",
            default: "a heavy, ultra-compacted mass of doubled mineral bedrock"
        }
    },
    "jalfinn+jalfinn": {
        name: "Supersonic Vacuum Tempest",
        compoundName: "Vacuum Tempest",
        stem: "Jaljal",
        desc: "compounded barometric pressure differentials, shrieking vacuum shears, and high-mach cyclonic storms",
        adj: "Supersonic Tempest",
        noun: "Vacuum Gale",
        prefix: "Hyper-Aero",
        coat: "Frictionless Vacuum Mantle",
        edge: "Molecular Vacuum Blade",
        synergyBuff: "Aerodynamic Resonance: Dual atmospheric matrices strip air friction entirely, accelerating constructs beyond Mach 3.",
        hazardText: null,
        shapes: {
            yangga: "a hyper-compressed needle of absolute vacuum propelled at Mach 3",
            taddum: "an invisible, molecular-level guillotine crescent of pure vacuum shear",
            gilbo: "a howling, double-cyclonic sphere of extreme barometric pressure differentials",
            yinla: "a piercing, straight-line lance of frictionless Mach-3 laminar wind shear",
            praba: "a shrieking, pressurized air cushion that violently repels all physical vector force",
            ngisngi: "a dual-spinning aerovane chakram of screaming vacuum blades",
            apap: "a wide, flaring gale cone of supersonic shockwaves that flattens everything in its path",
            abbay: "a 360-degree howling cyclone tempest that rips apart enemy formations",
            default: "a shrieking vortex of doubled barometric wind and pure vacuum shears"
        }
    },
    "iklad+iklad": {
        name: "Superconducting Dielectric Overdrive",
        compoundName: "Dielectric Overdrive",
        stem: "Iklikl",
        desc: "hyper-amperage dielectric breakdown, superconducting arcs, and relentless high-voltage discharge",
        adj: "Superconducting",
        noun: "Arc-Storm",
        prefix: "Hyper-Ionic",
        coat: "Superconducting Corona",
        edge: "Dielectric Arc Blade",
        synergyBuff: "Dielectric Overdrive: Dual electrical conduits multiply amperage, causing high-voltage arcs to branch uncontrollably across conductive matter.",
        hazardText: "Bio-Electric Overload Hazard (Hlakbil): Channeling double-voltage dielectric lightning through somatic conduits risks full neuromuscular seizure without Hardening (Kunta).",
        shapes: {
            yangga: "a blinding, multi-million volt bolt of superconducting dielectric lightning",
            taddum: "a crackling, oscillating arc-blade of pure high-amperage electricity",
            gilbo: "a humming, violently unstable ball-lightning core pulsing with continuous sparks",
            yinla: "a blinding, continuous laser-straight arc of ionizing multi-gigawatt discharge",
            praba: "an electrified Faraday cage that vaporizes and shocks incoming attacks on contact",
            ngisngi: "a spinning corona ring of crackling electric arcs and blinding induction loops",
            apap: "a branching, conical web of high-amperage fork lightning that fries entire ranks",
            abbay: "an electrified electromagnetic storm cage of pure lightning that covers the battlefield",
            default: "a crackling, violently overcharged surge of doubled high-voltage electricity"
        }
    },
    "erlaaw+erlaaw": {
        name: "Hyper-Coherent Solar Supernova",
        compoundName: "Photonic Supernova",
        stem: "Erlerl",
        desc: "zero-dispersion photonic coherence, blinding solar incandescence, and permanent optical daylight",
        adj: "Hyper-Coherent",
        noun: "Supernova",
        prefix: "Hyper-Photonic",
        coat: "Supernova Prism Mantle",
        edge: "Coherent Laser Edge",
        synergyBuff: "Photonic Coherence: Dual light channels achieve 100% optical coherence, eliminating all beam dispersion over any distance.",
        hazardText: null,
        shapes: {
            yangga: "a pinpoint needle of zero-dispersion hard-light photonic radiation",
            taddum: "a gleaming light-saber of hyper-coherent solar luminance and diamond precision",
            gilbo: "a brilliant, miniature supernova sun of blinding optical radiance",
            yinla: "a zero-dispersion, multi-terawatt photonic laser beam that cuts through all matter",
            praba: "a translucent, double-layered prism barrier that refracts and reflects all attacks",
            ngisngi: "a gleaming solar halo pulsing with blinding stroboscopic starlight flashes",
            apap: "an overwhelming, wide-angle flare of retinal-scorching optical radiation",
            abbay: "a domain of total optical daylight that permanently purges all shadows and illusions",
            default: "a brilliant, double-concentrated mass of hyper-coherent hard-light radiance"
        }
    },
    "worulim+worulim": {
        name: "Absolute Event Horizon",
        compoundName: "Event Horizon",
        stem: "Worwor",
        desc: "absolute null-space, sensory-devouring darkness, and irreversible matter-erasing entropy",
        adj: "Absolute Null",
        noun: "Event Horizon",
        prefix: "Hyper-Umbral",
        coat: "Singularity Void Shroud",
        edge: "Absolute Void Edge",
        synergyBuff: "Total Entropic Collapse: Dual void roots establish an absolute event horizon that irreversibly consumes matter, light, and foreign mana.",
        hazardText: null,
        shapes: {
            yangga: "a light-devouring needle of condensed absolute null-space that erases matter on contact",
            taddum: "a razor-thin scythe of spatial excision that cleanly erases matter from reality",
            gilbo: "an absolute event-horizon singularity orb that drags all surrounding light and sound into oblivion",
            yinla: "a focused, straight-line piercing beam of total entropic nullification",
            praba: "an opaque wall of absolute shadow that swallows all incoming physical and magical attacks",
            ngisngi: "a revolving eclipse ring of dark matter and entropic void tendrils",
            apap: "a suffocating cone of absolute darkness that completely erases heat, sound, and light",
            abbay: "a creeping domain of total null-space that dissolves matter and snuffs out perception",
            default: "a swirling, light-devouring shroud of absolute abyssal darkness"
        }
    },
    "amin+amin": {
        name: "Unbound Astral Font",
        compoundName: "Astral Overcharge",
        stem: "Aminamin",
        desc: "pure unfiltered astral kinetic mana overcharged into raw, reality-warping etheric force",
        adj: "Unbound Astral",
        noun: "Ether-Font",
        prefix: "Hyper-Arcane",
        coat: "Astral Aegis Core",
        edge: "Absolute Etheric Edge",
        synergyBuff: "Absolute Mana Purity: Doubled pure mana resonance instantly destabilizes and shatters all active foreign spellcraft and shields.",
        hazardText: null,
        shapes: {
            yangga: "a crystalline, needle-sharp dart of pure condensed ether vibrating with astral force",
            taddum: "a shimmering ethereal edge attuned to cleanly dismantling foreign magical bonds",
            gilbo: "a humming, perfectly balanced orb of double-density unformatted astral power",
            yinla: "a dense, coherent ray of pure kinetic etheric resonance that tears through wards",
            praba: "a hexagonal double-lattice barrier of pure mana that dispels incoming magic",
            ngisngi: "a spinning runic ring of pure mana matrices pulsing with etheric harmonics",
            apap: "a sweeping, flaring wave of raw magical force that completely purges foreign spells",
            abbay: "a high-density mana domain that completely overloads local magical ley lines",
            default: "a concentrated, double-density mass of pure kinetic mana"
        }
    },

    // -------------------------------------------------------------
    // B. 28 DUAL-ELEMENT REACTION HYBRIDS
    // -------------------------------------------------------------
    "sfalhoy+hanhum": {
        name: "Scalding Thermal Vapor",
        compoundName: "Scald-Steam",
        stem: "Shalhan",
        desc: "superheated thermal vapor, dense scalding fog, and explosive hydrothermal pressure",
        adj: "Scalding",
        noun: "Steam",
        prefix: "Hydro-Thermal",
        coat: "Vapor Mantle",
        edge: "Scalding Edge",
        synergyBuff: "Thermal Cavitation: Superheated steam expands violently upon impact, delivering intense thermal scalding and explosive hydrostatic shock.",
        hazardText: "Vapor Flashback Hazard (Hlakbil): Superheated steam blowback risks severe thermal burns to the caster's lungs and forearms without Adamantine Hardening (Kunta) or Prismatic Barrier (Praba).",
        shapes: {
            yangga: "a needle-thin jet of hyper-pressurized, superheated white steam",
            taddum: "an oscillating vapor-blade that sears and slices with industrial thermal pressure",
            gilbo: "a volatile, churning sphere of compressed scalding fog and pressurized water",
            yinla: "a focused, supersonic beam of superheated steam that cooks through metal and flesh",
            praba: "a thick, impenetrable wall of scalding thermal fog that blinds and burns oncoming attackers",
            ngisngi: "a spinning annular halo of scalding vapor currents and heated droplets",
            apap: "a roaring, wide-angled cone of superheated scalding vapor that boils the battlefield",
            abbay: "a room-wide cloud of suffocating thermal steam that blinds foes and sears respiratory tracts",
            default: "a dense, churning cloud of scalding thermal steam and pressurized moisture"
        }
    },
    "falga+sfalhoy": {
        name: "Molten Volcanic Magma",
        compoundName: "Magma",
        stem: "Shalfal",
        desc: "viscous molten bedrock, basalt slag, and explosive volcanic pressure",
        adj: "Volcanic",
        noun: "Magma",
        prefix: "Pyro-Clastic",
        coat: "Obsidian Lava Carapace",
        edge: "Molten Edge",
        synergyBuff: "Volcanic Slag Density: Fuses heavy bedrock mass with liquid combustion, leaving pools of lingering molten lava that melt through physical armor.",
        hazardText: null,
        shapes: {
            yangga: "a lance of liquid magma tipped with needle-sharp volcanic obsidian",
            taddum: "a serrated scythe of cooling basalt encasing a core of white-hot liquid lava",
            gilbo: "a gravitationally dense orb of roiling molten magma and superheated stone",
            yinla: "a continuous high-velocity stream of pulverized liquid lava and molten slag",
            praba: "a solid, towering slab of molten basalt that melts incoming weapons on contact",
            ngisngi: "an orbiting ring of spinning molten rock shards and dripping lava",
            apap: "a violent, flaring eruption cone of molten volcanic ejecta and volcanic ash",
            abbay: "a wide caldera domain of bubbling molten lava and upheaved volcanic spires",
            default: "a heavy, roiling mass of molten volcanic rock and liquid fire"
        }
    },
    "jalfinn+sfalhoy": {
        name: "Hyper-Oxygen Firestorm",
        compoundName: "Firestorm",
        stem: "Shaljal",
        desc: "howling atmospheric gales feeding a voracious, self-accelerating thermal inferno",
        adj: "Infernal Tempest",
        noun: "Firestorm",
        prefix: "Aero-Combustion",
        coat: "Convection Mantle",
        edge: "Combustion Shear Edge",
        synergyBuff: "Combustion Convection: Aerodynamic drafts feed superheated flames, expanding blast radius and thermal velocity exponentially.",
        hazardText: "Hypoxia Asphyxiation Hazard: Rapid atmospheric combustion starves the immediate radius of breathable oxygen.",
        shapes: {
            yangga: "a spiraling vortex needle of white-hot compressed thermal gale",
            taddum: "an invisible crescent of vacuum wind edged in superheated plasma flames",
            gilbo: "a shrieking, self-contained firestorm sphere of cyclonic thermal energy",
            yinla: "a laser-straight lance of high-mach laminar wind shear and roaring fire",
            praba: "a whirling vortex wall of fire that deflects and incinerates incoming projectile attacks",
            ngisngi: "a rapidly whirling aerovane chakram of vacuum blades wrapped in roaring fire",
            apap: "a sweeping, wide-angled firestorm cone that flattens and incinerates everything in its path",
            abbay: "a 360-degree cyclonic inferno enclosing the battlefield in a vortex of raging flames",
            default: "a howling vortex of high-velocity barometric wind and roiling fire"
        }
    },
    "iklad+sfalhoy": {
        name: "Ionized Thermal Plasma",
        compoundName: "Plasma Arc",
        stem: "Shalikl",
        desc: "superheated thermal plasma charged with high-voltage dielectric ionizing arcs",
        adj: "Thermal Plasma",
        noun: "Plasma",
        prefix: "Thermo-Ionic",
        coat: "Plasma Corona",
        edge: "Plasma Arc Blade",
        synergyBuff: "Thermo-Electric Ionization: Combines superheated plasma with dielectric discharge, vaporizing conductive armor and organic tissue simultaneously.",
        hazardText: null,
        shapes: {
            yangga: "a pinpoint, blinding bolt of superheated ionized plasma",
            taddum: "an oscillating arc-blade of pure high-voltage electricity and white-hot fire",
            gilbo: "a violently unstable ball-lightning core contained inside a roaring plasma sphere",
            yinla: "a continuous laser-straight beam of ionizing electric plasma discharge",
            praba: "a humming Faraday barrier of superheated plasma that electrocutes and melts attackers",
            ngisngi: "a spinning corona ring of crackling electric arcs and swirling plasma ribbons",
            apap: "a branching cone of high-voltage fork lightning carrying roaring waves of fire",
            abbay: "an electromagnetic storm field of ionized plasma arcs that blankets the perimeter",
            default: "a crackling, violently unstable surge of high-voltage thermal plasma"
        }
    },
    "erlaaw+sfalhoy": {
        name: "Solar Photonic Flare",
        compoundName: "Sunfire",
        stem: "Shalerl",
        desc: "blinding optical radiance fused with thermonuclear combustion and solar radiation",
        adj: "Solar Flare",
        noun: "Sunfire",
        prefix: "Helio-Thermal",
        coat: "Solar Corona Mantle",
        edge: "Photonic Flare Edge",
        synergyBuff: "Radiant Fusion: Blinding optical radiance combined with intense thermal heat, permanently blinding and flash-incinerating targets.",
        hazardText: null,
        shapes: {
            yangga: "a pinpoint needle of hard-light solar radiance blazing with thermonuclear heat",
            taddum: "a gleaming solar-blade of coherent hard-light and roaring flame",
            gilbo: "a brilliant miniature sun of blinding optical radiance and superheated plasma",
            yinla: "a zero-dispersion solar laser beam that vaporizes matter upon contact",
            praba: "a gleaming, refractive solar shield that blinds attackers and incinerates kinetic strikes",
            ngisngi: "a spinning solar halo pulsing with rhythmic starlight flashes and scorching heat",
            apap: "an overwhelming, wide-angle flare of blinding optical radiation and dragon-breath flame",
            abbay: "a domain of total optical daylight and searing heat that purges all darkness and burns foes",
            default: "a brilliant, concentrated mass of hard-light radiance and raging fire"
        }
    },
    "sfalhoy+worulim": {
        name: "Entropic Netherflame",
        compoundName: "Netherflame",
        stem: "Shalwor",
        desc: "light-devouring black fire that burns with absolute zero cold while consuming matter into the void",
        adj: "Abyssal Nether",
        noun: "Black Fire",
        prefix: "Umbral-Pyro",
        coat: "Netherflame Carapace",
        edge: "Void-Fire Edge",
        synergyBuff: "Void Combustion: Burns with cold entropic fury while consuming both physical matter and mana reserves directly into the void.",
        hazardText: null,
        shapes: {
            yangga: "a light-devouring needle of condensed black flame that freezes and dissolves matter",
            taddum: "a razor-thin scythe of black fire that shears matter and devours light on contact",
            gilbo: "an event-horizon orb of swirling black flames pulling surrounding light into darkness",
            yinla: "a straight-line beam of entropic black fire that leaves a wake of rotted void matter",
            praba: "a towering wall of opaque black flames that absorbs spells and disintegrates kinetic hits",
            ngisngi: "a revolving eclipse ring of dark flames and entropic tendrils",
            apap: "a suffocating cone of black flames that snuffs out heat, sound, and light in its wake",
            abbay: "a creeping miasmic domain of sensory-nullifying shadow and cold black flames",
            default: "a swirling, light-consuming shroud of abyssal black fire"
        }
    },
    "amin+sfalhoy": {
        name: "Primordial Ether-Flame",
        compoundName: "Astral Fire",
        stem: "Shalamin",
        desc: "raw unaspected astral mana accelerated into pure, incandescent primordial combustion",
        adj: "Primordial",
        noun: "Ether-Flame",
        prefix: "Astral-Pyro",
        coat: "Ether-Flame Aegis",
        edge: "Astral Blazing Edge",
        synergyBuff: "Etheric Overcharge: Raw mana fuels thermal reaction, bypassing conventional physical and elemental armor.",
        hazardText: null,
        shapes: {
            yangga: "a crystalline dart of pure ether blazing with incandescent white flame",
            taddum: "a shimmering ethereal blade wrapped in roaring primordial fire",
            gilbo: "a humming, perfectly balanced orb of raw mana combusting in violet plasma",
            yinla: "a dense, coherent ray of raw kinetic ether and searing laser-grade heat",
            praba: "a hexagonal lattice barrier of pure mana reinforced with roaring flame sheets",
            ngisngi: "a spinning runic ring of pure mana matrices igniting the air in sparks of fire",
            apap: "a sweeping, flaring wave of raw magical force and roaring flames",
            abbay: "a high-density mana field of overcharged ether-flame that destabilizes hostile magic",
            default: "a concentrated, unformatted mass of pure kinetic mana and raging combustion"
        }
    },
    "falga+hanhum": {
        name: "Tectonic Quagmire",
        compoundName: "Quagmire",
        stem: "Hanfal",
        desc: "liquefied bedrock, dense mineral silt, and crushing hydrostatic quagmire momentum",
        adj: "Quagmire",
        noun: "Mudflow",
        prefix: "Geo-Hydraulic",
        coat: "Silt-Armor Carapace",
        edge: "Liquefaction Edge",
        synergyBuff: "Hydrostatic Liquefaction: Liquefies ground into an inescapable crushing mire, drowning and immobilizing heavily armored targets.",
        hazardText: null,
        shapes: {
            yangga: "a high-pressure javelin of compacted mineral silt and dense gravel",
            taddum: "a heavy, abrasive slab-blade of high-speed liquefied stone and water",
            gilbo: "a gravitationally dense boulder of compressed mud and pressurized fluid",
            yinla: "an industrial-grade hydro-abrasive cutting beam of liquid mud and pulverized bedrock",
            praba: "a surging rectangular wall of dense, impact-absorbing mud and solid bedrock",
            ngisngi: "a spinning annular ring of razor-sharp silt currents and orbiting stone shards",
            apap: "a torrential, expanding cone of pressurized mud and seismic gravel",
            abbay: "a field-wide quagmire that submerges the battlefield into churning liquid earth",
            default: "a dense, heavy volume of pressurized water mixed with compacted mineral earth"
        }
    },
    "hanhum+jalfinn": {
        name: "Cryogenic Glacial Blizzard",
        compoundName: "Blizzard",
        stem: "Hanjal",
        desc: "sub-zero barometric tempests, screaming hail flurries, and absolute-zero frost",
        adj: "Glacial",
        noun: "Blizzard",
        prefix: "Cryo-Tempest",
        coat: "Glacial Frost Mantle",
        edge: "Cryogenic Ice Edge",
        synergyBuff: "Barometric Freezing: Atmospheric decompression plunges fluid temperatures to absolute zero, flash-freezing everything caught in the gale.",
        hazardText: null,
        shapes: {
            yangga: "a hyper-pressurized, needle-pointed icicle-javelin propelled by vacuum wind",
            taddum: "a high-frequency oscillating ice-blade capable of sub-zero laminar shearing",
            gilbo: "a howling, self-contained sphere of cryogenic ice and cyclonic barometric pressure",
            yinla: "a piercing, straight-line lance of high-mach freezing wind and razor ice crystals",
            praba: "a thick, crystalline wall of permafrost ice that absorbs impacts and freezes weapons",
            ngisngi: "a spinning annular ring of razor-sharp ice blades and howling cyclonic currents",
            apap: "a torrential, expanding cone of high-pressure freezing spray and shrieking gales",
            abbay: "an expansive, 360-degree blizzard tempest enclosing the battlefield in permafrost",
            default: "a swirling vortex of sub-zero atmospheric wind and dense cryogenic fluid"
        }
    },
    "hanhum+iklad": {
        name: "Conductive Storm Surge",
        compoundName: "Storm Surge",
        stem: "Hanikl",
        desc: "pressurized electrolytic fluid carrying high-voltage dielectric currents",
        adj: "Storm Surge",
        noun: "Tide-Bolt",
        prefix: "Hydro-Electric",
        coat: "Electrolytic Mantle",
        edge: "Conductive Wave Edge",
        synergyBuff: "Electrolytic Conduction: Fluid saturation turns the entire target area into an inescapable high-voltage electrical grid.",
        hazardText: "Electrolytic Backfire Hazard (Hlakbil): Discharging high-voltage electricity into fluid vessels without Ground Insulation risks self-electrocution.",
        shapes: {
            yangga: "a pinpoint, blinding bolt of ionized water propelled at supersonic speed",
            taddum: "a high-frequency water-blade crackling with jagged high-voltage electricity",
            gilbo: "a humming ball of pressurized water crackling with unstable dielectric arcs",
            yinla: "an industrial hydro-abrasive cutting beam carrying a continuous high-voltage arc",
            praba: "an electrified fluid cascade that absorbs physical force and shocks on contact",
            ngisngi: "a spinning annular ring of pressurized water carrying a crackling corona of arcs",
            apap: "a wide, branching cone of high-pressure freezing spray laced with fork lightning",
            abbay: "an electrified flood that submerges the battlefield and turns the ground into a live circuit",
            default: "a crackling, surging torrent of pressurized water and raw high-voltage electricity"
        }
    },
    "erlaaw+hanhum": {
        name: "Refractive Prismatic Aurora",
        compoundName: "Prismatic Mist",
        stem: "Hanerl",
        desc: "photonic hard-light dispersed through pressurized fluid into blinding refractive aurora arrays",
        adj: "Prismatic",
        noun: "Aurora",
        prefix: "Hydro-Photonic",
        coat: "Refractive Prism Mantle",
        edge: "Prismatic Wave Edge",
        synergyBuff: "Optical Dispersion: Water droplets act as infinite micro-prisms, splitting light into disorienting blinding laser arrays.",
        hazardText: null,
        shapes: {
            yangga: "a hard-light photonic icicle that refracts into multiple piercing laser needles",
            taddum: "a gleaming light-saber of coherent water and hard-light luminance",
            gilbo: "a brilliant, miniature sun suspended inside a churning crystalline water sphere",
            yinla: "a zero-dispersion photonic laser beam channeled through an ultra-high PSI water stream",
            praba: "a translucent, refractive prism waterfall that disperses kinetic force and blinds foes",
            ngisngi: "a gleaming solar-water halo pulsing with rhythmic rainbow flashes",
            apap: "an overwhelming, wide-angle flare of blinding optical radiation and freezing spray",
            abbay: "a domain of total optical daylight and tidal currents that purges shadows and drowns targets",
            default: "a brilliant, concentrated mass of hard-light radiance and pressurized fluid"
        }
    },
    "hanhum+worulim": {
        name: "Abyssal Hadal Trench",
        compoundName: "Abyssal Trench",
        stem: "Hanwor",
        desc: "lightless hadal brine exerting deep-ocean trench pressure and entropic void decay",
        adj: "Hadal Void",
        noun: "Abyssal Brine",
        prefix: "Umbral-Hydraulic",
        coat: "Hadal Shroud",
        edge: "Abyssal Cutting Edge",
        synergyBuff: "Hadal Pressure: Crushes targets beneath the sensory-depriving, lightless weight of deep-ocean trench gravity and cold.",
        hazardText: null,
        shapes: {
            yangga: "a light-devouring needle of condensed hadal water that crushes and rots matter",
            taddum: "a razor-thin scythe of black water that cleaves armor and devours light on contact",
            gilbo: "an event-horizon orb of swirling black water pulling surrounding light into its core",
            yinla: "a focused piercing beam of entropic hadal fluid that dissolves matter under extreme PSI",
            praba: "an opaque wall of abyssal water that absorbs incoming mana and deadens kinetic impact",
            ngisngi: "a revolving eclipse ring of dark hadal currents and entropic tendrils",
            apap: "a suffocating cone of black ocean brine that snuffs out heat, sound, and light",
            abbay: "a creeping miasmic flood of sensory-nullifying shadow and crushing hadal water",
            default: "a swirling, light-consuming shroud of abyssal hadal water and shadow"
        }
    },
    "amin+hanhum": {
        name: "Flowing Astral Torrent",
        compoundName: "Astral Torrent",
        stem: "Hanamin",
        desc: "raw kinetic mana flowing as frictionless, ultra-dense etheric water",
        adj: "Astral Flow",
        noun: "Ether-Tide",
        prefix: "Astral-Hydraulic",
        coat: "Etheric Tide Mantle",
        edge: "Resonant Hydro-Edge",
        synergyBuff: "Laminar Mana Stream: High-density pure mana flows with frictionless fluid momentum, shattering foreign wards.",
        hazardText: null,
        shapes: {
            yangga: "a crystalline, needle-sharp dart of pure condensed ether and pressurized fluid",
            taddum: "a shimmering ethereal edge attuned to severing mana structures with fluid ease",
            gilbo: "a perfectly balanced, humming orb of unformatted astral water",
            yinla: "a dense, coherent ray of raw kinetic etheric resonance and high-pressure water",
            praba: "a hexagonal lattice barrier of pure mana reinforced by impact-absorbing fluid",
            ngisngi: "a spinning runic ring of pure mana matrices and laminar fluid ribbons",
            apap: "a sweeping, flaring wave of raw magical force and rushing water",
            abbay: "a high-density mana deluge that destabilizes and overcharges local magical channels",
            default: "a concentrated, unformatted mass of pure kinetic mana and pressurized fluid"
        }
    },
    "falga+jalfinn": {
        name: "Micro-Abrasive Sandstorm",
        compoundName: "Sandstorm",
        stem: "Faljal",
        desc: "high-mach cyclonic winds propelling dense clouds of razor-sharp mineral flak and bedrock sand",
        adj: "Tectonic Gale",
        noun: "Sandstorm",
        prefix: "Geo-Aero",
        coat: "Sandstorm Shroud",
        edge: "Abrasive Flak Edge",
        synergyBuff: "Particulate Flak Abrasion: High-mach winds propel pulverized mineral shards to strip flesh and armor down to the bone.",
        hazardText: null,
        shapes: {
            yangga: "a high-mach vortex spike of compressed air packed with diamond-hard sand flak",
            taddum: "an invisible crescent of vacuum wind edged in razor-sharp pulverized obsidian",
            gilbo: "a howling, self-contained sphere of cyclonic pressure and dense grinding bedrock",
            yinla: "a piercing, straight-line lance of high-speed abrasive gravel and laminar wind shear",
            praba: "a turbulent air cushion carrying a swirling cloud of granite shards that shreds projectiles",
            ngisngi: "a shrieking, spinning aerovane chakram of vacuum blades and orbiting stone shards",
            apap: "a wide, flaring gale cone of pulverized mineral debris that strips armor on contact",
            abbay: "an expansive, 360-degree sandstorm maelstrom that shreds visibility and armor",
            default: "a swirling vortex of high-velocity barometric wind and grinding bedrock flak"
        }
    },
    "falga+iklad": {
        name: "Polarized Magnetic Fulgurite",
        compoundName: "Fulgurite",
        stem: "Falikl",
        desc: "ferromagnetic bedrock fused into glass-edged fulgurite and magnetized by dielectric lightning",
        adj: "Magnetic",
        noun: "Fulgurite",
        prefix: "Geo-Ionic",
        coat: "Fulgurite Carapace",
        edge: "Magnetized Arc Edge",
        synergyBuff: "Ferromagnetic Induction: Lightning fuses stone into glass-edged fulgurite while violently magnetizing metallic armor.",
        hazardText: null,
        shapes: {
            yangga: "a jagged, diamond-hard lance of electrified obsidian crackling with dielectric arcs",
            taddum: "a heavy, razor-edged slab of tectonic basalt carrying high-voltage electric ribbons",
            gilbo: "a gravitationally dense boulder of compressed bedrock humming with ball lightning",
            yinla: "a continuous spear-line of pulverized high-speed gravel laced with continuous electric arcs",
            praba: "an impenetrable monolithic slab of fortified bedrock acting as an electrified Faraday wall",
            ngisngi: "an orbiting ring of jagged stone shards pulsing with high-voltage magnetic induction",
            apap: "a violent, flaring cone of seismic debris and branching fork lightning",
            abbay: "an electrified electromagnetic bastion of upheaved tectonic plates and lightning spires",
            default: "a crackling, heavy mass of mineral bedrock and raw high-voltage electricity"
        }
    },
    "erlaaw+falga": {
        name: "Crystalline Photolith",
        compoundName: "Crystal Light",
        stem: "Falerl",
        desc: "photonic hard-light solidified into everlasting, diamond-hard refractive quartz bedrock",
        adj: "Photolithic",
        noun: "Crystal",
        prefix: "Geo-Photonic",
        coat: "Quartz Diamond Mantle",
        edge: "Crystal Light Edge",
        synergyBuff: "Hard-Light Mineralization: Solidifies photonic beams into permanent, diamond-hard crystal quartz structures.",
        hazardText: null,
        shapes: {
            yangga: "a jagged, diamond-hard lance of crystalline hard-light quartz",
            taddum: "a gleaming, weightless light-saber of coherent hard-light and razor-edged granite",
            gilbo: "a solid, gravitationally dense boulder of gleaming crystal quartz pulsing with light",
            yinla: "a zero-dispersion beam of searing photonic laser light channeled through crystal lenses",
            praba: "an impenetrable, monolithic slab of fortified crystal that reflects and disperses strikes",
            ngisngi: "an orbiting ring of gleaming solar crystals pulsing with rhythmic starlight flashes",
            apap: "a violent, flaring cone of radiant crystal shards and blinding optical flare",
            abbay: "a field-wide bastion of upheaved crystal prisms that illuminates and fortifies the area",
            default: "a brilliant, heavy compacted mass of mineral bedrock and hard-light radiance"
        }
    },
    "falga+worulim": {
        name: "Obsidian Void Singularity",
        compoundName: "Obsidian Void",
        stem: "Falwor",
        desc: "hyper-dense dark mineral bedrock exerting gravitational null-space pull and crushing decay",
        adj: "Obsidian Void",
        noun: "Null-Stone",
        prefix: "Geo-Umbral",
        coat: "Obsidian Void Carapace",
        edge: "Null-Stone Edge",
        synergyBuff: "Tectonic Singularity: Hyper-dense black mineral absorbs light and pulls surrounding terrain into a localized gravity collapse.",
        hazardText: null,
        shapes: {
            yangga: "a light-devouring needle of dense, calcified obsidian null-space",
            taddum: "a heavy, razor-edged slab of dark matter and basalt that devours matter on contact",
            gilbo: "an event-horizon boulder that pulls surrounding light and earth into a dense singularity",
            yinla: "a focused, straight-line piercing spear of pulverized void stone and entropic gravel",
            praba: "an impenetrable, monolithic slab of black bedrock that absorbs spells and deadens impact",
            ngisngi: "an orbiting ring of jagged, rapidly spinning dark-matter stones",
            apap: "a suffocating cone of seismic shadow and pulverized black rock",
            abbay: "a creeping miasmic domain of upheaved black tectonic plates and entropic gravity sinks",
            default: "a swirling, light-consuming mass of mineral bedrock and abyssal darkness"
        }
    },
    "amin+falga": {
        ...
        stem: "Falamin",
        desc: "bedrock mineral infused with pure etheric matrices, crystallizing into indestructible adamantine",
        adj: "Adamantine",
        noun: "Runic Bedrock",
        prefix: "Geo-Arcane",
        coat: "Adamantine Runic Shell",
        edge: "Etheric Bedrock Edge",
        synergyBuff: "Etheric Fortification: Channels raw mana into mineral lattice for virtually indestructible physical and magical defenses.",
        hazardText: null,
        shapes: {
            yangga: "a crystalline, needle-sharp dart of pure condensed ether and calcified granite",
            taddum: "a heavy, razor-edged slab of tectonic flint attuned to severing mana structures",
            gilbo: "a solid, gravitationally dense boulder of humming, unformatted astral bedrock",
            yinla: "a dense, coherent spear-line of raw kinetic ether and pulverized high-speed gravel",
            praba: "a hexagonal lattice barrier of pure mana reinforced by monolithic bedrock",
            ngisngi: "a spinning runic ring of pure mana matrices and orbiting stone shards",
            apap: "a sweeping, flaring wave of raw magical force and seismic debris",
            abbay: "a high-density mana bastion of upheaved tectonic plates and overcharged ley lines",
            default: "a concentrated, unformatted mass of pure kinetic mana and mineral bedrock"
        }
    },
    "iklad+jalfinn": {
        name: "Ionized Hurricane Tempest",
        compoundName: "Tempest",
        stem: "Jalikl",
        desc: "screaming high-mach cyclonic gales charged with high-voltage dielectric ionizing lightning arcs",
        adj: "Tempestuous",
        noun: "Hurricane",
        prefix: "Aero-Ionic",
        coat: "Storm-Eye Corona",
        edge: "Tempest Arc Blade",
        synergyBuff: "Dielectric Gale: Violent wind shears strip electrons from the atmosphere to create a self-perpetuating localized lightning storm.",
        hazardText: null,
        shapes: {
            yangga: "a pinpoint, blinding bolt of dielectric lightning wrapped in a supersonic vortex",
            taddum: "an invisible vacuum blade crackling with high-voltage electrical ribbons",
            gilbo: "a howling, self-contained sphere of cyclonic pressure humming with ball lightning",
            yinla: "a blinding, laser-straight arc of ionizing electrical discharge and high-mach wind shear",
            praba: "a turbulent air cushion acting as an electrified Faraday shield to repel all attacks",
            ngisngi: "a shrieking aerovane chakram of vacuum blades pulsing with magnetic induction arcs",
            apap: "a wide, flaring gale cone carrying a branching web of high-voltage fork lightning",
            abbay: "an expansive cyclonic hurricane enclosing the battlefield in high-voltage lightning",
            default: "a swirling vortex of high-velocity barometric wind and raw high-voltage electricity"
        }
    },
    "erlaaw+jalfinn": {
        ...
        stem: "Jalerl",
        desc: "frictionless aerodynamic wind currents guiding coherent hard-light beams with zero atmospheric loss",
        adj: "Solar Zephyr",
        noun: "Photonic Wind",
        prefix: "Aero-Photonic",
        coat: "Slipstream Prism Mantle",
        edge: "Hard-Light Wind Edge",
        synergyBuff: "Zero-Dispersion Aerodynamics: Wind slipstreams channel light rays with zero atmospheric loss, ensuring maximum velocity.",
        hazardText: null,
        shapes: {
            yangga: "a needle-thin vortex spike of hard-light photonic radiation",
            taddum: "a gleaming, weightless light-saber of coherent solar luminance and vacuum shear",
            gilbo: "a howling, self-contained sphere of cyclonic pressure and blinding optical radiance",
            yinla: "a coherent, zero-dispersion beam of searing photonic laser light riding a laminar jet",
            praba: "a translucent, refractive prism sheet that deflects kinetic force on cushions of air",
            ngisngi: "a shrieking aerovane chakram of vacuum blades pulsing with rhythmic starlight flashes",
            apap: "an overwhelming, wide-angle flare of blinding optical radiation and howling gale gusts",
            abbay: "a domain of total optical daylight and cyclonic tempest enclosing the battlefield",
            default: "a swirling vortex of high-velocity barometric wind and hard-light radiance"
        }
    },
    "jalfinn+worulim": {
        name: "Matter-Erasing Void Hurricane",
        compoundName: "Void Hurricane",
        stem: "Jalwor",
        desc: "howling atmospheric vortexes of absolute vacuum that pull physical matter directly into null-space",
        adj: "Abyssal Gale",
        noun: "Void Tempest",
        prefix: "Aero-Umbral",
        coat: "Vacuum Void Mantle",
        edge: "Spatial Excision Blade",
        synergyBuff: "Atmospheric Excision: Creates howling vortexes of absolute vacuum that pull matter directly into null-space.",
        hazardText: null,
        shapes: {
            yangga: "a light-devouring needle of condensed null-space propelled by a vacuum vortex",
            taddum: "an invisible scythe of vacuum shear and spatial excision that devours matter on contact",
            gilbo: "an event-horizon orb of cyclonic barometric pressure pulling all light into its core",
            yinla: "a focused, straight-line piercing beam of entropic nullification and high-mach wind",
            praba: "a turbulent air cushion of abyssal shadow that absorbs mana and deadens kinetic force",
            ngisngi: "a shrieking aerovane chakram of vacuum blades wrapped in entropic dark tendrils",
            apap: "a suffocating cone of absolute darkness and howling winds that snuffs out all energy",
            abbay: "an expansive cyclonic hurricane of creeping miasmic shadow and matter-erasing vacuum",
            default: "a swirling, light-consuming vortex of high-velocity barometric wind and darkness"
        }
    },
    "amin+jalfinn": {
        name: "Aero-Resonant Mana Vortex",
        compoundName: "Resonant Vortex",
        stem: "Jalamin",
        desc: "unformatted kinetic ether accelerated through aerodynamic slipstreams to hyper-mach velocities",
        adj: "Aero-Resonant",
        noun: "Ether-Vortex",
        prefix: "Aero-Arcane",
        coat: "Resonant Slipstream Aegis",
        edge: "Ether-Shear Edge",
        synergyBuff: "Kinetic Velocity Amp: Accelerates raw mana darts to hyper-mach velocities, maximizing armor penetration.",
        hazardText: null,
        shapes: {
            yangga: "a crystalline, needle-sharp dart of pure condensed ether riding a vacuum vortex",
            taddum: "an invisible, sub-molecular slicing crescent of shearing gale and pure mana",
            gilbo: "a howling, self-contained sphere of cyclonic pressure and humming astral energy",
            yinla: "a dense, coherent ray of raw kinetic etheric resonance and high-mach laminar wind",
            praba: "a hexagonal lattice barrier of pure mana reinforced by pressurized air cushions",
            ngisngi: "a shrieking, spinning runic aerovane chakram of pure mana matrices and vacuum blades",
            apap: "a sweeping, flaring wave of raw magical force and howling barometric gale",
            abbay: "a high-density mana tempest that destabilizes and overcharges local magical channels",
            default: "a swirling vortex of high-velocity barometric wind and pure kinetic mana"
        }
    },
    "erlaaw+iklad": {
        name: "Coherent Radiant Arc-Laser",
        compoundName: "Radiant Arc",
        stem: "Iklerl",
        desc: "photonic laser beams pre-ionizing air conduits to guide high-voltage dielectric lightning instantaneously",
        adj: "Radiant Arc",
        noun: "Laser-Bolt",
        prefix: "Photo-Ionic",
        coat: "Photonic Corona",
        edge: "Laser-Arc Edge",
        synergyBuff: "Photonic Dielectric Discharge: Laser tracks ionize the air ahead of time, ensuring 100% accuracy and zero latency for lightning strikes.",
        hazardText: null,
        shapes: {
            yangga: "a pinpoint needle of hard-light photonic radiation carrying a dielectric lightning charge",
            taddum: "a gleaming light-saber of coherent solar luminance crackling with high-voltage arcs",
            gilbo: "a brilliant, miniature sun pulsing with unstable ball lightning and optical radiance",
            yinla: "a coherent, zero-dispersion beam of searing photonic laser light and continuous dielectric arc",
            praba: "a translucent, refractive prism sheet that acts as a live electrified Faraday barrier",
            ngisngi: "a spinning corona ring of crackling electric arcs and pulsing starlight flashes",
            apap: "an overwhelming, wide-angle flare of blinding optical radiation and branching fork lightning",
            abbay: "an electrified electromagnetic storm cage of pure solar daylight and ionizing lightning",
            default: "a brilliant, concentrated mass of hard-light radiance and raw high-voltage electricity"
        }
    },
    "iklad+worulim": {
        name: "Black Lightning Entropic Spark",
        compoundName: "Black Lightning",
        stem: "Iklwor",
        desc: "negative dielectric arcs laced with entropic void energy that rots biological tissue and neural conduits",
        adj: "Umbral Spark",
        noun: "Black Lightning",
        prefix: "Umbral-Ionic",
        coat: "Black Corona Mantle",
        edge: "Entropic Arc Edge",
        synergyBuff: "Neural Decay Discharge: Negative dielectric arcs travel through the nervous system, rotting synapses and motor pathways.",
        hazardText: "Neural Entropic Shock Hazard (Hlakbil): Channeling black lightning without Adamantine Hardening (Kunta) risks permanent neuro-degenerative recoil to the caster.",
        shapes: {
            yangga: "a light-devouring needle of condensed void crackling with black electric sparks",
            taddum: "a razor-thin scythe of spatial excision carrying high-voltage black lightning ribbons",
            gilbo: "an event-horizon orb humming with violently unstable black ball lightning",
            yinla: "a focused, straight-line piercing beam of entropic nullification and black electric discharge",
            praba: "an opaque wall of abyssal shadow that acts as an electrified entropic barrier",
            ngisngi: "a revolving eclipse ring of dark matter and crackling black electric arcs",
            apap: "a suffocating cone of absolute darkness laced with branching black fork lightning",
            abbay: "a creeping miasmic domain of sensory-nullifying shadow and ionizing black lightning",
            default: "a crackling, light-consuming surge of raw high-voltage black electricity"
        }
    },
    "amin+iklad": {
        name: "Unfiltered Etheric Arc-Burst",
        compoundName: "Etheric Surge",
        stem: "Iklamin",
        desc: "pure astral mana overcharged into high-voltage dielectric frequencies that instantly rupture foreign spellcraft",
        adj: "Etheric Surge",
        noun: "Mana-Bolt",
        prefix: "Ionic-Arcane",
        coat: "Etheric Corona Aegis",
        edge: "Spellbreak Arc Edge",
        synergyBuff: "Dielectric Spellbreak: Pure mana lightning overloads and shatters foreign magical circles upon contact.",
        hazardText: null,
        shapes: {
            yangga: "a crystalline, needle-sharp dart of pure condensed ether and dielectric lightning",
            taddum: "a shimmering ethereal edge crackling with high-voltage mana arcs",
            gilbo: "a humming, perfectly balanced orb of unformatted astral power and ball lightning",
            yinla: "a dense, coherent ray of raw kinetic etheric resonance and ionizing electric discharge",
            praba: "a hexagonal lattice barrier of pure mana acting as an electrified Faraday shield",
            ngisngi: "a spinning runic ring of pure mana matrices pulsing with magnetic induction arcs",
            apap: "a sweeping, flaring wave of raw magical force and branching fork lightning",
            abbay: "a high-density mana field of ionizing electric arcs that destabilizes hostile magic",
            default: "a concentrated, unformatted mass of pure kinetic mana and raw high-voltage electricity"
        }
    },
    "erlaaw+worulim": {
        name: "Twilight Eclipse Singularity",
        compoundName: "Twilight Eclipse",
        stem: "Erlwor",
        desc: "the impossible fusion of blinding solar radiance and light-devouring void, causing continuous space-rending equilibrium",
        adj: "Twilight",
        noun: "Penumbra",
        prefix: "Equinox",
        coat: "Eclipse Shroud",
        edge: "Penumbra Blade",
        synergyBuff: "Penumbra Equilibrium: Radiance and void annihilate at the focal point, releasing pure space-rending reality distortions.",
        hazardText: "Annihilation Instability Hazard: Fusing pure radiance with the abyss creates intense mana recoil; requires firm mental control.",
        shapes: {
            yangga: "a bifurcated dart of hard-light radiance encasing a core of light-devouring void",
            taddum: "a gleaming light-saber of coherent solar luminance edged in spatial excision scythes",
            gilbo: "an eclipse orb containing a miniature sun locked inside a swirling event horizon",
            yinla: "a zero-dispersion beam of searing photonic laser light surrounded by an entropic void sleeve",
            praba: "a translucent prism sheet woven with abyssal shadow that absorbs spells and reflects strikes",
            ngisngi: "a revolving eclipse ring of pulsing starlight flashes and entropic dark tendrils",
            apap: "an overwhelming, wide-angle flare of blinding optical radiation and suffocating darkness",
            abbay: "a domain of total optical penumbra that purges all conventional magic through spatial annihilation",
            default: "a swirling, brilliant mass of hard-light radiance and abyssal void darkness"
        }
    },
    "amin+erlaaw": {
        name: "Sacred Crystalline Solar Light",
        compoundName: "Solar Mana",
        stem: "Erlamin",
        desc: "photonic hard-light supercharged with raw astral mana, purging foreign curses and illusions",
        adj: "Solar Astral",
        noun: "Radiant Ether",
        prefix: "Photo-Arcane",
        coat: "Prismatic Aegis",
        edge: "Sacred Hard-Light Edge",
        synergyBuff: "Purifying Ether: Amplifies photonic coherence into celestial purifying frequencies that instantly purge foreign curses and illusions.",
        hazardText: null,
        shapes: {
            yangga: "a crystalline, needle-sharp dart of pure condensed ether and hard-light radiance",
            taddum: "a shimmering ethereal edge attuned to severing mana structures with solar precision",
            gilbo: "a brilliant, miniature sun of perfectly balanced unformatted astral power",
            yinla: "a dense, coherent ray of raw kinetic etheric resonance and searing photonic laser light",
            praba: "a hexagonal lattice barrier of pure mana reinforced by refractive hard-light prisms",
            ngisngi: "a spinning runic ring of pure mana matrices pulsing with rhythmic starlight flashes",
            apap: "a sweeping, flaring wave of raw magical force and blinding optical radiation",
            abbay: "a high-density mana domain of total optical daylight that purges all foreign magic",
            default: "a concentrated, unformatted mass of pure kinetic mana and hard-light radiance"
        }
    },
    "amin+worulim": {
        name: "Absolute Entropic Null-Arcana",
        compoundName: "Null-Arcana",
        stem: "Woramin",
        desc: "raw etheric mana polarized into an all-consuming anti-magic void that devours foreign spell matrices",
        adj: "Null-Arcane",
        noun: "Void Ether",
        prefix: "Umbral-Arcane",
        coat: "Null-Aegis Shroud",
        edge: "Null-Arcana Edge",
        synergyBuff: "Total Spell Devourer: Actively consumes ambient and hostile mana constructs to feed its own void volume.",
        hazardText: null,
        shapes: {
            yangga: "a crystalline dart of pure ether tuned into a light-devouring needle of condensed null-space",
            taddum: "a shimmering ethereal edge that excises matter and sever foreign mana bonds on contact",
            gilbo: "a humming orb of raw astral power collapsing inward into an event-horizon singularity",
            yinla: "a dense ray of raw kinetic ether and focused entropic nullification",
            praba: "a hexagonal lattice barrier of pure mana that absorbs and devours hostile spells",
            ngisngi: "a spinning runic ring of pure mana matrices and entropic dark tendrils",
            apap: "a sweeping, flaring wave of raw magical force and suffocating darkness",
            abbay: "a high-density mana void that actively dissolves and feeds upon foreign magic",
            default: "a concentrated, light-consuming mass of pure kinetic mana and abyssal void"
        }
    }
};

function getHybridReaction(el1, el2) {
    if (!el1 || !el2) return null;
    const key1 = `${el1}+${el2}`;
    const key2 = `${el2}+${el1}`;
    return HYBRID_REACTIONS[key1] || HYBRID_REACTIONS[key2] || null;
}
...
function getSomaticShapeTitle(elKey, part, shapeId, hybrid) {
    const t = hybrid ? {
        adj: hybrid.adj,
        noun: hybrid.noun,
        prefix: hybrid.prefix,
        dragon: `${hybrid.noun} Drake's`,
        coat: hybrid.coat,
        edge: hybrid.edge
    } : (ELEMENT_THEMES[elKey] || ELEMENT_THEMES.amin);
    ...
    if (hybrid) return `${hybrid.compoundName} ${HLAKBIL_ANATOMY_BASE[elKey][part] || 'Infusion'}`;
...
const IMPACT_LORE_MATRIX = {
    ...
    waras: {
        ...
        amin: {
            ...
            ruluwar: "the mana construct disperses swarms of etheric darts to pepper enemy defenses",
